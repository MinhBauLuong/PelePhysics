...
void eval_jacob (const double, const double, const double * restrict, double * restrict);
...
void eval_rxn_rates (const double, const double, const double * restrict, double * restrict, double * restrict);
