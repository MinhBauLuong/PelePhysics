...
//    /* Reorganization */
//    for (int k=0; k<30; k++) {
//        J_reorg[k*30 + 29] = J[k*30 + 0];
//        for (int i=0; i<29; i++) {
//            J_reorg[k*30 + i] = J[k*30 + (i + 1)];
//        }
//    }
//    for (int k=0; k<30; k++) {
//        J[29*30 + k] = J_reorg[k];
...
void aJacobian(double * restrict J, double * restrict sc, double T, int consP)
{
    ...
    if (consP) {
        ...
        dqdc[0] = q_nocor;
        dqdc[1] = q_nocor + k_f*sc[9];
        dqdc[2] = TB[0][0]*q_nocor;
        dqdc[3] = TB[0][1]*q_nocor;
        dqdc[4] = TB[0][2]*q_nocor;
        dqdc[5] = TB[0][3]*q_nocor;
        dqdc[6] = q_nocor;
        dqdc[7] = q_nocor;
        dqdc[8] = q_nocor - k_r;
        dqdc[9] = q_nocor + k_f*sc[1];
        dqdc[10] = q_nocor;
        dqdc[11] = q_nocor;
        dqdc[12] = q_nocor;
        dqdc[13] = q_nocor;
    ...
    if (consP) {
        ...
        dqdc[0] = q_nocor;
        dqdc[1] = q_nocor;
        dqdc[2] = TB[1][0]*q_nocor;
        dqdc[3] = TB[1][1]*q_nocor;
        dqdc[4] = TB[1][2]*q_nocor;
        dqdc[5] = TB[1][3]*q_nocor;
        dqdc[6] = q_nocor - k_r*2*sc[6];
        dqdc[7] = q_nocor + k_f;
        dqdc[8] = q_nocor;
        dqdc[9] = q_nocor;
        dqdc[10] = q_nocor;
    ...
    if (consP) {
        ...
        dqdc[2] = q_nocor;
        dqdc[3] = q_nocor;
        dqdc[4] = q_nocor - k_r*sc[9];
        dqdc[5] = q_nocor;
        dqdc[6] = q_nocor;
        dqdc[7] = q_nocor;
        dqdc[8] = q_nocor;
        dqdc[9] = q_nocor - k_r*sc[4];
        dqdc[10] = q_nocor;
        dqdc[11] = q_nocor;
        dqdc[12] = q_nocor;
        dqdc[13] = q_nocor + k_f;
